...
def get_roast_response(prompt):
    res = groq_client.chat.completions.create(
        ...
        messages=[{"role": "system", "content": (
                "You are a quick-witted, observational comedian who specializes in funny, lighthearted comparisons. "
                "Your goal is to make people laugh with clever analogies and gentle teasing, not to offend or make anyone feel genuinely bad. "
                "Keep your comparisons relatable and unexpected, like a friendly jab. "
                "Always end your response with 'GIF:' followed by a description of a funny, playful reaction."
                "Think common reaction GIFs, not niche scenarios." 
            )},
...
def roast():
    ...
    prompt = f"Come up with a funny, lighthearted comparison or observation about this:\n'{user_input}'\nMake it amusing and witty, but absolutely NOT offensive. End with GIF: description."
